          ...
          <div className="text-[10px] leading-relaxed opacity-60 text-justify space-y-2">
            {language === "uk" && (
              <>
                ...
                <p>
                  <strong>1. ЗАГАЛЬНІ ПОЛОЖЕННЯ:</strong> Інформація, інструменти, калькулятори та матеріали, розміщені на веб-сайті taxered.com (далі — "Сервіс"), надаються виключно в інформаційних та освітніх цілях і не є професійною юридичною, податковою, фінансовою або бухгалтерською консультацією. Використання Сервісу не створює відносин "консультант-клієнт" між користувачем та власником сайту.
                </p>
                <p>
            ...
            {language === "pl" && (
              <>
                ...
                <p>
                  <strong>1. POSTANOWIENIA OGÓLNE:</strong> Informacje, narzędzia, kalkulatory i materiały dostępne na stronie taxered.com (dalej "Serwis") są udostępniane wyłącznie w celach informacyjnych i edukacyjnych i nie stanowią profesjonalnej porady prawnej, podatkowej, finansowej ani księgowej. Korzystanie z Serwisu nie tworzy relacji doradca-klient między użytkownikiem a właścicielem strony.
                </p>
                <p>
            ...
            {language === "en" && (
              <>
                ...
                <p>
                  <strong>4. COMPLETE DISCLAIMER OF LIABILITY:</strong> The owner, developer, operator, and all related parties of the taxered.com website SHALL NOT BE LIABLE (including but not limited to) for: (a) any direct, indirect, incidental, punitive, special, or consequential damages; (b) loss of profit, revenue, data, or savings; (c) penalties, fines, sanctions, or additional tax assessments from tax authorities; (d) errors in calculations or documents; (e) any actions or omissions of the user related to the use of the Service; (f) inability to use the Service or interruptions in its operation.
                </p>
                <p>
            ...
            {language === "es" && (
              <>
                ...
                <p>
                  <strong>1. DISPOSICIONES GENERALES:</strong> La información, herramientas, calculadoras y materiales disponibles en el sitio web taxered.com (el "Servicio") se proporcionan únicamente con fines informativos y educativos y no constituyen asesoramiento profesional legal, fiscal, financiero o contable. El uso del Servicio no crea una relación asesor-cliente entre el usuario y el propietario del sitio web.
                </p>
                <p>
            ...
            {language === "pt" && (
              <>
                ...
                <p>
                  <strong>1. DISPOSIÇÕES GERAIS:</strong> As informações, ferramentas, calculadoras e materiais disponíveis no site taxered.com (o "Serviço") são fornecidos exclusivamente para fins informativos e educacionais e não constituem aconselhamento profissional jurídico, fiscal, financeiro ou contábil. O uso do Serviço não cria uma relação consultor-cliente entre o usuário e o proprietário do site.
                </p>
                <p>
